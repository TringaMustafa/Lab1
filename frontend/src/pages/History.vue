        ...
        <div v-else class="space-y-4">
          ...
          >
            <div class="flex items-center justify-between mb-2">
              ...
              <div class="px-3 py-1 rounded-full text-xs border border-white/10 bg-white/10">
            ...
            <div v-if="order.items?.length" class="space-y-2">
              <div
                ...
                :key="item.id"
                class="flex items-center justify-between text-sm border-t border-white/10 pt-2"
              >
